...
function decorateRemovedRows() {
  ...
  [...tbody.querySelectorAll('tr')].forEach(row => {
    ...
    if (!actions.querySelector('[data-action="restore"]')) {
      ...
      restore.className = 'ab-btn ab-restore'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; restore.style.cssText = 'background:#dcfce7;color:#166534;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer';
    ...
    if (!actions.querySelector('[data-action="delete"]') && !actions.querySelector('[data-ab-delete-hotfix]')) {
      ...
      del.className = 'ab-btn ab-delete'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer'; del.style.cssText = 'background:#fee2e2;color:#991b1b;border:0;border-radius:8px;padding:7px 10px;margin:2px;font-weight:700;cursor:pointer';
