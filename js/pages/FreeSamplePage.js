...
function sampleStyles() {
  ...
  style.textContent = `
    ...
    .bs-modal-head{height:68px;flex:0 0 68px;background:rgba(255,255,255,.97);border-bottom:1px solid #e2e8f0;display:flex;align-items:center;padding:0 22px;box-sizing:border-box;position:relative;z-index:2}
    ...
    .bs-close{position:fixed;left:max(18px,calc(50% - 510px));top:50%;transform:translateY(-50%);width:48px;height:48px;border:1px solid #dbe3ee;border-radius:14px;background:#fff;color:#1e293b;display:grid;place-items:center;cursor:pointer;font-size:25px;font-weight:700;line-height:1;z-index:10001;box-shadow:0 10px 28px rgba(15,23,42,.20);transition:.15s ease}.bs-close:hover{background:#f8fafc;transform:translateY(-50%) translateX(-2px);box-shadow:0 14px 32px rgba(15,23,42,.25)}
    ...
    .bs-loading{width:min(760px,100%);box-sizing:border-box;background:#fff;border:1px solid #dbe3ee;border-radius:12px;padding:90px 20px;text-align:center;color:#64748b;font-size:13px;font-weight:800}.bs-error{width:min(760px,100%);box-sizing:border-box;background:#fff;border:1px solid #fecaca;border-radius:14px;padding:34px 20px;text-align:center;color:#991b1b}.bs-error p{color:#64748b;margin:8px 0 18px;font-size:13px}.bs-actions{display:flex;justify-content:center;gap:9px;flex-wrap:wrap}.bs-btn{display:inline-flex;align-items:center;justify-content:center;min-height:40px;padding:0 15px;border-radius:10px;text-decoration:none;font-size:12px;font-weight:800}.bs-secondary{background:#fff;color:#334155;border:1px solid #dbe3ee}
...
export function renderFreeSamplePage(book) {
  ...
  return `
    <div class="bs-overlay" id="bookora-free-sample-page" role="dialog" aria-modal="true" aria-label="Free sample">
      <button type="button" class="bs-close" id="bookora-sample-close" aria-label="Close sample" title="Back to book">←</button>
      <div class="bs-modal">
