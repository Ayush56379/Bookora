...
export function renderPublishInternalPage() {
  ...
  return `<div class="publish-page" style="background:var(--bg-secondary);min-height:85vh;padding:2rem 0 5rem;"><div class="container" style="max-width:900px;"><div style="text-align:center;margin-bottom:2rem;"><div class="badge badge-bookora" style="margin-bottom:.5rem;">Author Studio</div><h1>Publish Your eBook</h1><p style="color:var(--text-secondary);">Complete the steps below. Large files upload in resumable chunks and automatically retry temporary failures.</p></div>
