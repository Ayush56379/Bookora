...
(() => {
  ...
  const routeModules = {
    ...
    '/publish': ['./publish-enhancements.js?v=20260826-1','./publish-success-finalizer.js?v=20260826-1','./publish-concurrency-safety.js?v=20260828-1','./publish-submit-progress-ui.js?v=20260828-1'],
