...
// All optional runtimes live under /js. Resolve every module from that
...
(() => {
  const modules = [
    ...
    './firebase-authenticated-fetch.js?v=20260823-4', './external-seller-auth-persistence-fix.js?v=20260823-5',
    './external-auth-submit-bridge.js?v=20260823-7', './catalog-visibility-hotfix.js?v=20260823-1', './auth-session-bridge.js?v=20260821-3',
    ...
    './final-click-safety.js?v=20260823-1', './ai-click-fix.js?v=20260823-1', './seller-wallet-route.js?v=20260823-1',
    './book-detail-complete.js?v=20260823-1', './book-detail-permanent-fix.js?v=20260819-6',
  ...
  const resolveJsSrc = src => src.replace(/^\.\//, './js/');

  const loadOne = async src => {
    const resolvedSrc = resolveJsSrc(src);
    try {
      await import(resolvedSrc);
    } catch (error) {
      console.warn('[Bookora optional runtime skipped]', resolvedSrc, error);
    }
  };
