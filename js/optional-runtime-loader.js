...
(() => {
  ...
  const EARLY_SELLER_RUNTIME = './seller-apply-empty-fields-v4.js?v=20260827-5';
  const EARLY_SELLER_UI_RUNTIME = './seller-apply-ui-v5.js?v=20260827-1';
  const modules = [
