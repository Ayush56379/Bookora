...
export function renderFooter() {
  ...
  return `
    <footer class="bookora-footer" aria-label="Bookora footer"><div class="bookora-footer__container">
      <section class="bookora-footer__trust-strip" aria-label="Bookora service highlights">
        <div class="bookora-footer__trust-item"><span class="bookora-footer__trust-icon trust-blue">♢</span><div><strong>Secure Payments</strong><small>100% safe &amp; protected</small></div></div><div class="bookora-footer__trust-item"><span class="bookora-footer__trust-icon trust-blue">ϟ</span><div><strong>Instant Access</strong><small>Download instantly</small></div></div><div class="bookora-footer__trust-item"><span class="bookora-footer__trust-icon trust-green">✓</span><div><strong>Verified Content</strong><small>Quality checked eBooks</small></div></div><div class="bookora-footer__trust-item"><span class="bookora-footer__trust-icon trust-purple">♧</span><div><strong>Creator Friendly</strong><small>Empowering creators</small></div></div><div class="bookora-footer__trust-item"><span class="bookora-footer__trust-icon trust-orange">◌</span><div><strong>24/7 Support</strong><small>We're here to help</small></div></div>
      </section>
      <div class="bookora-footer__main">
        <section class="bookora-footer__brand"><a href="#/" class="bookora-footer__brand-link" aria-label="Bookora home"><span class="bookora-footer__logo" aria-hidden="true"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg></span><span>Bookora</span></a><p class="bookora-footer__description">Discover digital books, read verified publications, and publish your own work through a modern eBook marketplace built for readers and creators.</p><div class="bookora-footer__socials" aria-label="Bookora social links">${social || '<span class="bookora-footer__social-note">Social channels will be added soon.</span>'}</div><div class="bookora-footer__security-card"><span class="bookora-footer__security-icon">🔒</span><div><strong>Secure payments &amp; protected content</strong><p>All transactions are handled through the platform's configured payment services and content-access controls.</p><a href="#/privacy">Learn more about security →</a></div></div></section>
